...
<div class = "panel panel-primary">
    ...
    <h3 class = "panel-title">BIODATA SUPPLIER</h3>
</div>
    <div class = "panel-body">
        <form method = "post" action = "hasillanjut.php">
        <input type="hidden" name="aksi" value="create">
            <table>
        <tr>
            <td width = "160px">Nama Supplier</td>
            <td>
        ...
        <tr>
                    ...
                    <td>
                        <input type = "textarea" name = "supplier_alamat" class = "form-control" required>
        </td>
        </tr>
        <tr>
                    <td>No HP Supplier</td>
                    <td>
                        <input type = "text" name = "supplier_no_telp" class = "form-control" required>
        </td>
        </tr>
        <tr>
